...
# Make a hyper plane
hyperplane1 = torch.nn.Linear(2,2)
torch.nn.init.xavier_normal_(hyperplane1.weight)
hyperplane2 = torch.nn.Linear(2,1)
torch.nn.init.xavier_normal_(hyperplane2.weight)
activ_relu = torch.nn.ReLU()
activ_sigm = torch.nn.Sigmoid()

model = torch.nn.Sequential(hyperplane1, activ_sigm, hyperplane2, activ_sigm)
